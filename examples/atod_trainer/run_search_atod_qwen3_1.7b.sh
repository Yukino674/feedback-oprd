...
experiment_name="atod_anneal_nocurr_search_qwen3_1.7b_teacher_grpo4b_step300_klInit${kl_coef}to${kl_coef_min}_rlInit${rl_coef}to${rl_coef_max}_T${coef_anneal_steps}_tip"
