"""SOD rollout skeleton with OPRD-Bridge hidden-only supervision."""
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with _timer("step", timing_raw):
                    ...
                    with _timer("teacher_forward_submit", timing_raw):
                        teacher_future = self._launch_teacher_oprd_bridge_hidden(batch)
                    ...
                    with _timer("teacher_forward", timing_raw):
                        teacher_hidden = self._materialize_teacher_oprd_bridge_hidden(teacher_future)
