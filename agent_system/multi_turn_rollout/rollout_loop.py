...
class TrajectoryCollector:
    ...
    def vanilla_multi_turn_loop(
        ...
        # Multi-turn weight-reuse fast path: sync FSDP->vLLM weights + wake_up ONCE
        # before the loop instead of on every turn. Default False -> original behavior.
        ...
        try:
            ...
            for _step in range(self.config.env.max_steps):
                ...
                if reuse_weights:
                    batch_output_padded = actor_rollout_wg.generate_sequences_in_rollout(batch_input_padded)
                else:
